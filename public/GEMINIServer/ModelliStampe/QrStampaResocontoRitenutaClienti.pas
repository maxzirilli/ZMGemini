unit QrStampaResocontoRitenutaClienti;
...
type
  TQR_STAMPA_RESOCONTO_RITENUTA_FATTURE = class(TQuickRep)
    ...
    BAND_GROUP_HEADER: TQRChildBand;
    QRLabel19: TQRLabel;
    QRLabel1: TQRLabel;
    QRLabel3: TQRLabel;
    QRLabel5: TQRLabel;
    LB_TOT_RITENUTE: TQRLabel;
    LB_TOT_CERTIF: TQRLabel;
    QRLabel4: TQRLabel;
    QRShape1: TQRShape;
    QRShape3: TQRShape;
    QRShape4: TQRShape;
    ...
    QRShape10: TQRShape;
    QRShape11: TQRShape;
    LB_TOTALE_DA_CERTIF: TQRLabel;
    DENOMINAZIONE_SOCIETA: TQRLabel;
    INTESTAZIONE_SOCIETA: TQRMemo;
    QR_LOGO: TQRImage;
    QRChildBand1: TQRChildBand;
    LB_TOTALE_RITENUTE_INCASSATE: TQRLabel;
    LB_TOTALE_DIFF_DA_CERTIF: TQRLabel;
    LB_RITENUTE_CERTIFICATE: TQRLabel;
    QRShape2: TQRShape;
    QRShape5: TQRShape;
    QRShape7: TQRShape;
    LB_ANNO: TQRLabel;
    ...
    procedure BAND_RESOCONTO_RITENUTENeedData(Sender: TObject;
      var MoreData: Boolean);
    procedure QuickRepBeforePrint(Sender: TCustomQuickRep;
      var PrintReport: Boolean);
    procedure BAND_RESOCONTO_RITENUTEBeforePrint(Sender: TQRCustomBand;
    ...
    procedure LB_TOT_CERTIFPrint(sender: TObject; var Value: string);
  private
...
procedure TQR_STAMPA_RESOCONTO_RITENUTA_FATTURE.BAND_RESOCONTO_RITENUTEBeforePrint(
...
procedure TQR_STAMPA_RESOCONTO_RITENUTA_FATTURE.BAND_RESOCONTO_RITENUTENeedData(
...
procedure TQR_STAMPA_RESOCONTO_RITENUTA_FATTURE.LB_TOT_CERTIFPrint(
  sender: TObject; var Value: string);
begin

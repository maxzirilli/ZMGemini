...
type
  TQR_STAMPA_PRODOTTI = class(TQuickRep)
    BAND_INTESTAZIONE: TQRBand;
    LB_TITOLO: TQRLabel;
    DENOMINAZIONE_SOCIETA: TQRLabel;
    INTESTAZIONE_SOCIETA: TQRMemo;
    QR_LOGO: TQRImage;
    LB_DESCRIZIONE: TQRLabel;
    LB_SOGLIA_DI_ALLARME: TQRLabel;
    LB_CODICE: TQRLabel;
...
{$R *.DFM}
Procedure TQR_STAMPA_PRODOTTI.EsportaSuFile(FileName : String);
...
procedure TQR_STAMPA_PRODOTTI.BAND_PRIMA_RATABeforePrint(
...
procedure TQR_STAMPA_PRODOTTI.BAND_PRIMA_RATANeedData(
...
procedure TQR_STAMPA_PRODOTTI.BAND_SECONDA_RATABeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  PrintBand := LB_SCADENZA_SECONDA_RATA.Caption <> '';
end;

procedure TQR_STAMPA_PRODOTTI.BAND_TERZA_RATABeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  PrintBand := LB_SCADENZA_TERZA_RATA.Caption <> '';
end;

procedure TQR_STAMPA_PRODOTTI.BAND_TOTALI_FATTURABeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  PrintBand := LB_SCADENZA_SECONDA_RATA.Caption <> '';
end;

Procedure TQR_STAMPA_PRODOTTI.Init(Connection : TpFIBQuery; ListaFatture : TStringList;
                                            Suggerimento : TStringList; AddTitolo : String;
                                            ProgressBar : TProgressBar);
begin
...
procedure TQR_STAMPA_PRODOTTI.LB_NS_AVEREPrint(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('0.00',FTotale - FTotPagato);
end;

procedure TQR_STAMPA_PRODOTTI.LB_TOTALE_INCASSO_RESOCONTOPrint(sender: TObject;
  var Value: string);
begin
  Value := FormatFloat('0.00',FTotPagato)
end;

procedure TQR_STAMPA_PRODOTTI.LB_TOTALE_RESOCONTOPrint(sender: TObject; var Value: string);
begin
  Value := FormatFloat('0.00',FTotale);
end;

procedure TQR_STAMPA_PRODOTTI.LB_TERZA_RATAPrint(sender: TObject; var Value: string);
begin
  Value := ' ';
end;

procedure TQR_STAMPA_PRODOTTI.QuickRepBeforePrint(
...
procedure TQR_STAMPA_PRODOTTI.QuickRepPreview(Sender: TObject);
begin

...
type
  TQR_STAMPA_RESOCONTO_FATTURE = class(TQuickRep)
    ...
    LB_CAB: TQRLabel;
    LB_DATA_SCADENZA: TQRLabel;
    LB_IMPORTO: TQRLabel;
    BAND_GROUP_FOOTER: TQRBand;
    QRChildBand1: TQRChildBand;
    QRLabelImporto: TQRLabel;
    QRLabelDataScadenza: TQRLabel;
    QRLabel1: TQRLabel;
    QRLabel3: TQRLabel;
    QRLabel15: TQRLabel;
    QRLabel5: TQRLabel;
    LB_TOTALE_RESOCONTO: TQRLabel;
    ...
    procedure BAND_LOOPING_ROWNeedData(Sender: TObject;
      var MoreData: Boolean);
    procedure QuickRepBeforePrint(Sender: TCustomQuickRep;
      var PrintReport: Boolean);
    procedure BAND_LOOPING_ROWBeforePrint(Sender: TQRCustomBand;
...
procedure TQR_STAMPA_RESOCONTO_FATTURE.BAND_LOOPING_ROWBeforePrint(
...
procedure TQR_STAMPA_RESOCONTO_FATTURE.BAND_LOOPING_ROWNeedData(

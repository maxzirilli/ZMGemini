object QR_STAMPA_RESOCONTO_PREVENTIVI: TQR_STAMPA_RESOCONTO_PREVENTIVI
  Left = 0
  Top = 0
  Width = 1572
  Height = 1111
  ...
  object DetailResocontoPreventivi: TQRSubDetail
    Left = 53
    Top = 329
    Width = 1466
    Height = 32
    ...
    AlignToBottom = False
    BeforePrint = DetailResocontoPreventiviBeforePrint
    Color = clWhite
    TransparentBand = False
    Font.Charset = ANSI_CHARSET
    Font.Color = clWindowText
    ...
    OnNeedData = DetailResocontoPreventiviNeedData
    PrintBefore = False
    PrintIfEmpty = False
  ...
  object BAND_GROUP_FOOTER: TQRBand
    ...
    object LB_TOT_PREVENTIVI: TQRLabel
      Left = 905
      Top = 6
      Width = 71
      Height = 22
      ...
      Font.Name = 'Times New Roman'
      Font.Style = []
      OnPrint = LB_TOT_PREVENTIVIPrint
      ParentFont = False
      Transparent = False
      WordWrap = True
      ExportAs = exptText

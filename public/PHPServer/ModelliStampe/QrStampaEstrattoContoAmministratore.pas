unit QrStampaEstrattoContoAmministratore;
...
type
  TQR_STAMPA_FATTURA = class(TQuickRep)
    ...
    QRLabel20: TQRLabel;
    LB_IMPORTO_DA_PAGARE_TOTALE: TQRLabel;
    QRShape12: TQRShape;
    QryRateFattura: TpFIBDataSet;
    DENOMINAZIONE_SOCIETA: TQRLabel;
    INTESTAZIONE_SOCIETA: TQRMemo;
    QR_LOGO: TQRImage;
    QRShape42: TQRShape;
    DESTINATARIO: TQRMemo;
    BAND_ELENCO_FATTURE: TQRChildBand;
    BAND_TOTALE_PARZIALE: TQRChildBand;
    QRLabel2: TQRLabel;
    QRLabel4: TQRLabel;
    LB_NUMERO_FATTURA: TQRLabel;
    LB_DATA_FATTURA: TQRLabel;
    QRLabel1: TQRLabel;
    QRLabel3: TQRLabel;
    QRLabel6: TQRLabel;
    LB_TOTALE_DA_PAGARE: TQRLabel;
    QRShape49: TQRShape;
    QRLabel7: TQRLabel;
    QR_MEMO_IBAN: TQRMemo;
    LB_TOTALE_DA_PAGARE_CONDOMINIO: TQRLabel;
    LB_NOME_CONDOMINIO: TQRLabel;
    QRShape1: TQRShape;
    QRShape2: TQRShape;
    QRShape3: TQRShape;
    QRShape4: TQRShape;
    QRShape5: TQRShape;
    LB_NOME_CAUSALE: TQRLabel;
    LB_NOME_AMMINISTRATORE: TQRLabel;
    ...
    procedure BAND_NOME_CONDOMINIOBeforePrint(Sender: TQRCustomBand;
      var PrintBand: Boolean);
    ...
    procedure BAND_FOOTERBeforePrint(Sender: TQRCustomBand;
      var PrintBand: Boolean);
    ...
    procedure BAND_ELENCO_FATTUREBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
...
{$R *.DFM}
procedure TQR_STAMPA_FATTURA.BAND_FOOTERBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var i                 : Integer;
...
Constructor TQR_STAMPA_FATTURA.Create(AOwner : TComponent);
begin
...
Destructor TQR_STAMPA_FATTURA.Destroy;
begin
 FHandleImage.Free;
 FListaVoci.Clear;
 FListaVoci.Free;
...
Procedure TQR_STAMPA_FATTURA.Init(Connection : TpFIBQuery; ChiaveFattura : Integer);
begin
...
procedure TQR_STAMPA_FATTURA.QuickRepPreview(Sender: TObject);
begin
...
procedure TQR_STAMPA_FATTURA.RATADATAPrint(sender: TObject;var Value: string);
begin
 Value := ' ';
...
procedure TQR_STAMPA_FATTURA.RATA_IMPONIBILE1Print(sender: TObject;var Value: string);
begin
 Value := ' ';
 if FRateImponibili.Count >= TComponent(Sender).Tag then
    begin
...
procedure TQR_STAMPA_FATTURA.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
...
procedure TQR_STAMPA_FATTURA.QuickRepAfterPrint(Sender: TObject);
begin
...
procedure TQR_STAMPA_FATTURA.DENOMINAZIONE_SOCIETAPrint(sender: TObject;
  var Value: String);
begin
 Value := SystemInformation.DenominazioneSocieta;
end;

procedure TQR_STAMPA_FATTURA.BAND_ELENCO_FATTUREBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TQR_STAMPA_FATTURA.BAND_HEADER_RATEBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  PrintBand := FRateImponibili.Count > 3
end;

procedure TQR_STAMPA_FATTURA.BAND_INTESTAZIONEBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TQR_STAMPA_FATTURA.QRLabel30Print(sender: TObject;var Value: string);
begin
 Value := SostBoolean(QryFatture.FieldByName('ANNO_FATTURA').IsNull,' ','Nr. documento');
end;

procedure TQR_STAMPA_FATTURA.QRLabel34Print(sender: TObject;
  var Value: string);
begin
...
procedure TQR_STAMPA_FATTURA.QRLabel7Print(sender: TObject;
  var Value: string);
begin
...
procedure TQR_STAMPA_FATTURA.BAND_NOME_CONDOMINIOBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var Quantita             : Double;
...
procedure TQR_STAMPA_FATTURA.QRSubDetail2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
 PrintBand := FRateImponibili.Count > 3
end;

procedure TQR_STAMPA_FATTURA.LB_NOTA_FATTURAPrint(sender: TObject;
  var Value: string);
begin
...
Procedure TQR_STAMPA_FATTURA.LB_NS_IBANPrint(sender: TObject;
  var Value: string);
begin
  Value := SystemInformation.IBAN;
end;

procedure TQR_STAMPA_FATTURA.LB_NUM_DOCUMENTOPrint(sender: TObject;
  var Value: string);
begin
...
procedure TQR_STAMPA_FATTURA.LB_RIF_ORDINEPrint(sender: TObject;
  var Value: string);
begin
  Value := QryFatture.FieldByName('RIF_VOSTRO_ORDINE').AsString;
end;

procedure TQR_STAMPA_FATTURA.LB_TIPO_DOCUMENTOPrint(sender: TObject; var Value: string);
begin
 if QryFatture.FieldByName('ANNO_FATTURA').IsNull then
...
procedure TQR_STAMPA_FATTURA.LB_TRASPORTOPrint(sender: TObject;
  var Value: string);
begin
  Value := QryFatture.FieldByName('TRASPORTO').AsString;
end;

procedure TQR_STAMPA_FATTURA.LB_BANCAPrint(sender: TObject; var Value: string);
begin
...
procedure TQR_STAMPA_FATTURA.LB_CONDIZIONI_PAGAMENTOPrint(sender: TObject;
  var Value: string);
begin
...
procedure TQR_STAMPA_FATTURA.LB_DATA_DOCUMENTOPrint(sender: TObject; var Value: string);
...
procedure TQR_STAMPA_FATTURA.LB_DATA_ORDINEPrint(sender: TObject;
  var Value: string);
begin
...
procedure TQR_STAMPA_FATTURA.LB_DATA_RATA_GENERICAPrint(sender: TObject;
  var Value: string);
begin
  Value := FormatDateTime('dd/mm/yyyy',QryRateFattura.FieldByName('DATA').AsDateTime);
end;

procedure TQR_STAMPA_FATTURA.LB_IMPONIBILE_RATA_GENERICAPrint(sender: TObject;
  var Value: string);
begin

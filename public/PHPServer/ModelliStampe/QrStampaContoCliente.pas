...
type
  TQR_STAMPA_FATTURA = class(TQuickRep)
    ...
    BAND_FOOTER: TQRBand;
    QRLabel10: TQRLabel;
    LB_TOTALE_DARE: TQRLabel;
    LB_TOTALE_AVERE: TQRLabel;
    LB_TOTALE_SALDO: TQRLabel;
    MM_DESCRIZIONE_DOCUMENTO: TQRMemo;
    MM_CONTATTI_DESTINATARIO: TQRMemo;
    MM_AMMINISTRATORE: TQRMemo;
    MM_CONTATTI_AMMINISTRATORE: TQRMemo;
    LB_AMM: TQRLabel;
...
procedure TQR_STAMPA_FATTURA.BAND_SUMMARYBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var Quantita             : Double;

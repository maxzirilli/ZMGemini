...
type
  TQR_STAMPA_RESOCONTO_FATTURE = class(TQuickRep)
    ...
    LB_TOTALE_INCASSO_RESOCONTO: TQRLabel;
    ...
    QRLabel3: TQRLabel;
    QRLabel15: TQRLabel;
    LB_NS_AVERE: TQRLabel;
    QRLabel5: TQRLabel;
    LB_TOTALE_RESOCONTO: TQRLabel;
    LB_TOT_FATTURA: TQRLabel;
    LB_TOTALE_INCASSATO: TQRLabel;
    LB_TELEFONO: TQRMemo;
    QRLabel8: TQRLabel;
    LB_TOTALE_DA_INCASSARE: TQRLabel;
    QRLabel10: TQRLabel;
    QRMEMO_EMAIL: TQRMemo;
    QRLabel4: TQRLabel;
    QRShape2: TQRShape;
    QRShape3: TQRShape;
    QRShape6: TQRShape;

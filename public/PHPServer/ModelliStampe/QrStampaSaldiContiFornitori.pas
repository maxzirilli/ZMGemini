...
type
  TQR_STAMPA_SALDO = class(TQuickRep)
    ...
    BAND_ELENCO_CLIENTI: TQRChildBand;
    LB_CODICE_CLIENTE: TQRLabel;
    LB_SALDO: TQRLabel;
    QRShape8: TQRShape;
    QRShape11: TQRShape;
    LB_DESCRIZIONE_CLIENTE: TQRMemo;
    QRLabel2: TQRLabel;
    ...
    procedure BAND_ELENCO_CLIENTIBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
...
{$R *.DFM}
procedure TQR_STAMPA_SALDO.BAND_FOOTERBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var i                 : Integer;
...
Constructor TQR_STAMPA_SALDO.Create(AOwner : TComponent);
begin
...
Destructor TQR_STAMPA_SALDO.Destroy;
begin
 FHandleImage.Free;
 FListaVoci.Clear;
 FListaVoci.Free;
...
Procedure TQR_STAMPA_SALDO.Init(Connection : TpFIBQuery; ChiaveFattura : Integer);
begin
...
procedure TQR_STAMPA_SALDO.QuickRepPreview(Sender: TObject);
begin
...
procedure TQR_STAMPA_SALDO.RATADATAPrint(sender: TObject;var Value: string);
begin
 Value := ' ';
...
procedure TQR_STAMPA_SALDO.RATA_IMPONIBILE1Print(sender: TObject;var Value: string);
begin
 Value := ' ';
 if FRateImponibili.Count >= TComponent(Sender).Tag then
    begin
...
procedure TQR_STAMPA_SALDO.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
...
procedure TQR_STAMPA_SALDO.QuickRepAfterPrint(Sender: TObject);
begin
...
procedure TQR_STAMPA_SALDO.DENOMINAZIONE_SOCIETAPrint(sender: TObject;
  var Value: String);
begin
 Value := SystemInformation.DenominazioneSocieta;
end;

procedure TQR_STAMPA_SALDO.BAND_ELENCO_CLIENTIBeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
...
procedure TQR_STAMPA_SALDO.BAND_HEADER_RATEBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  PrintBand := FRateImponibili.Count > 3
end;

procedure TQR_STAMPA_SALDO.BAND_INTESTAZIONEBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TQR_STAMPA_SALDO.QRLabel30Print(sender: TObject;var Value: string);
begin
 Value := SostBoolean(QryFatture.FieldByName('ANNO_FATTURA').IsNull,' ','Nr. documento');
end;

procedure TQR_STAMPA_SALDO.QRLabel34Print(sender: TObject;
  var Value: string);
begin
...
procedure TQR_STAMPA_SALDO.QRLabel7Print(sender: TObject;
  var Value: string);
begin
...
procedure TQR_STAMPA_SALDO.BAND_SUMMARYBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var Quantita             : Double;
...
procedure TQR_STAMPA_SALDO.QRSubDetail2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
 PrintBand := FRateImponibili.Count > 3
end;

procedure TQR_STAMPA_SALDO.LB_NOTA_FATTURAPrint(sender: TObject;
  var Value: string);
begin
...
Procedure TQR_STAMPA_SALDO.LB_NS_IBANPrint(sender: TObject;
  var Value: string);
begin
  Value := SystemInformation.IBAN;
end;

procedure TQR_STAMPA_SALDO.LB_NUM_DOCUMENTOPrint(sender: TObject;
  var Value: string);
begin
...
procedure TQR_STAMPA_SALDO.LB_RIF_ORDINEPrint(sender: TObject;
  var Value: string);
begin
  Value := QryFatture.FieldByName('RIF_VOSTRO_ORDINE').AsString;
end;

procedure TQR_STAMPA_SALDO.LB_TIPO_DOCUMENTOPrint(sender: TObject; var Value: string);
begin
 if QryFatture.FieldByName('ANNO_FATTURA').IsNull then
...
procedure TQR_STAMPA_SALDO.LB_TRASPORTOPrint(sender: TObject;
  var Value: string);
begin
  Value := QryFatture.FieldByName('TRASPORTO').AsString;
end;

procedure TQR_STAMPA_SALDO.LB_BANCAPrint(sender: TObject; var Value: string);
begin
...
procedure TQR_STAMPA_SALDO.LB_CONDIZIONI_PAGAMENTOPrint(sender: TObject;
  var Value: string);
begin
...
procedure TQR_STAMPA_SALDO.LB_DATA_DOCUMENTOPrint(sender: TObject; var Value: string);
...
procedure TQR_STAMPA_SALDO.LB_DATA_ORDINEPrint(sender: TObject;
  var Value: string);
begin
...
procedure TQR_STAMPA_SALDO.LB_DATA_RATA_GENERICAPrint(sender: TObject;
  var Value: string);
begin
  Value := FormatDateTime('dd/mm/yyyy',QryRateFattura.FieldByName('DATA').AsDateTime);
end;

procedure TQR_STAMPA_SALDO.LB_IMPONIBILE_RATA_GENERICAPrint(sender: TObject;
  var Value: string);
begin

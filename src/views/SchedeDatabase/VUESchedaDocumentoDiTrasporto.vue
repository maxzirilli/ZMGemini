 ...
 <div class="ZMCorpoSchedeDati">
  <header class="panel-heading bg-light" >
     ...
     <div class="ZMNuovaRigaScheda" style="height:10px">&nbsp;</div>
      ...
      <div v-if="SchedaDocumentoDiTrasporto.Selezionato == 'C'" class="ZMNuovaRigaScheda">
        <div style="float:left; width:50%">
          ...
          <VUEInputClienti @onUpdate="newValue => SchedaDocumentoDiTrasporto.Dati.ID_ANAGRAFICA = newValue" :disabled="SchedaDocumentoDiTrasporto.Dati.ID_FATTURA != -1" v-model="SchedaDocumentoDiTrasporto.Dati.ID_ANAGRAFICA"/>
          <label v-if="SchedaDocumentoDiTrasporto.Dati.ID_ANAGRAFICA == -1 && SchedaDocumentoDiTrasporto.Selezionato == 'C'" class="ZMFormLabelError">Campo obbligatorio</label> 
        </div>
      </div>
      <div v-if="SchedaDocumentoDiTrasporto.Selezionato == 'F'" class="ZMNuovaRigaScheda">
        <div style="float:left; width:50%">
          ...
          <VUEInputFornitore :disabled="SchedaDocumentoDiTrasporto.Dati.ID_FATTURA != -1" v-model="SchedaDocumentoDiTrasporto.Dati.ID_ANAGRAFICA" emptyElement="true"/>
          <label v-if="SchedaDocumentoDiTrasporto.Dati.ID_ANAGRAFICA == -1 && SchedaDocumentoDiTrasporto.Selezionato == 'F'" class="ZMFormLabelError">Campo obbligatorio</label> 
        </div>
      </div>
      ...
      <div class="ZMSeparatoreScheda" style="margin-top:15px">       
        ...
        <VUEModalButtonRecapitiFiliali v-if="SchedaDocumentoDiTrasporto.Selezionato == 'C'"
                                     :styleForButton="'float:right; margin-right: 0px'"
                                     :IdCliente="SchedaDocumentoDiTrasporto.Dati.ID_ANAGRAFICA"
   ...
   <div v-if="Tabs.ActiveTab == 'VociDDT'">
    <div v-if="SchedaDocumentoDiTrasporto.Dati.ID_ANAGRAFICA != -1">
      ...
      <div class="ZMNuovaRigaScheda">
        ...
        <div style="width:24%; float:left">
          ...
          <select class="form-control" v-model="SchedaDocumentoDiTrasporto.Dati.PORTO" :disabled="SchedaDocumentoDiTrasporto.Dati.ID_FATTURA != -1">
            <option :value="''">-</option>
...
export default 
{
   ...
   computed :
   {
     CurrentCliente()
     {
       return this.SchedaDocumentoDiTrasporto.Dati.ID_ANAGRAFICA
     },
   ...
   methods: 
   {
    ...
    OnClickFornitore()
    {
      ...
      this.SchedaDocumentoDiTrasporto.Dati.ID_ANAGRAFICA   = -1

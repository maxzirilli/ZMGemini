<template>
<VUEConfirm :Popup="PopupContentCfgDescrizione" :PathLogo="require('../../assets/images/LogoGemini2.png')"
            :Programma="NomeProgramma"          :Richiesta="'Annullare le modifiche effettuate?'" @onClickConfermaPopup="ConfermaElimina" @onClickChiudiPopup="AnnullaElimina">
</VUEConfirm>
...
<script>
import { SystemInformation, RIFERIMENTO_CAUSALI,NOME_PROGRAMMA } from '@/SystemInformation';

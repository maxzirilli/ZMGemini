<template>
  <VUEConfirm :Popup="PopupContentCfgContropartita" :Programma="NomeProgramma" :PathLogo="require('@/assets/images/LogoGemini2.png')" 
...
export default 
{
  ...
  data()
  {
    ...
    var Colonna = DataTable.AddColumn('Codice',
    ...
    Colonna = DataTable.AddColumn('Descrizione',
                        TZDTableColumnType.typString,
                        'DESCRIZIONE',
                        "80%");
    Colonna.Ordinamento = true;
    ...
    return {
        ...
        PopupContentCfgContropartita : false,
  ...
  methods:
  {
    ...
    AnnullaElimina()
    {
       this.PopupContentCfgContropartita = false
    },
    OnClickAnnulla()
    {
       this.PopupContentCfgContropartita = true
    },
    Annulla()
    {
       var Self = this;

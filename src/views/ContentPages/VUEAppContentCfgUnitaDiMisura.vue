<template>
  <VUEConfirm :Popup="PopupContentCfgUnitaDiMisura" :Richiesta="'Annullare le modifiche effettuate?'" @onClickConfermaPopup="ConfermaElimina" @onClickChiudiPopup="AnnullaElimina">
  </VUEConfirm>
...
export default 
{
  ...
  data()
  {
    ...
    var Colonna = DataTable.AddColumn('Unità di misura',
    ...
    return {
        ...
        PopupContentCfgUnitaDiMisura : false
    }
  },
  components : 
  {
  ...
  methods:
  {
    ...
    AnnullaElimina()
    {
       this.PopupContentCfgUnitaDiMisura = false
    },
    OnClickAnnulla()
    {
       this.PopupContentCfgUnitaDiMisura = true
    },
    Annulla()
    {
       var Self = this;
